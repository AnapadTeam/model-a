/**
 * @file i2c.h
 * @brief Utility functions for I2C protocol interfacing.
 */

#ifndef MODEL_A_I2C_H
#define MODEL_A_I2C_H
...
/**
 * Opens a file descriptor to an I2C device.
 * @param dev_path the device path string
 * @return the I2C device file descriptor integer or a negative number if an error occurred
 */
